...
macro(config_nebula_client)
    ...
    list(APPEND CMAKE_MODULE_PATH ${CMAKE_BUILD_DIR}/modules/nebula)
    set(nebula_DIR ${client_build_dir}/modules/nebula)
    find_package(nebula)
    ...
    include_directories(AFTER ${client_source_dir}/modules/nebula/src/common)
    include_directories(AFTER ${client_build_dir}/modules/nebula/src/common)
