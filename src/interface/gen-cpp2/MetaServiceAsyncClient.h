...
class MetaServiceAsyncClient : public apache::thrift::GeneratedAsyncClient {
 ...
 public:
  virtual void balance(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::BalanceReq& p_req);
  virtual void balance(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::BalanceReq& p_req);
 protected:
  void balanceImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::BalanceReq& p_req);
 public:

  virtual void sync_balance( ::nebula::meta::cpp2::BalanceResp& _return, const  ::nebula::meta::cpp2::BalanceReq& p_req);
  virtual void sync_balance(apache::thrift::RpcOptions& rpcOptions,  ::nebula::meta::cpp2::BalanceResp& _return, const  ::nebula::meta::cpp2::BalanceReq& p_req);

  virtual folly::Future< ::nebula::meta::cpp2::BalanceResp> future_balance(const  ::nebula::meta::cpp2::BalanceReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::BalanceResp> semifuture_balance(const  ::nebula::meta::cpp2::BalanceReq& p_req);
  virtual folly::Future< ::nebula::meta::cpp2::BalanceResp> future_balance(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::BalanceReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::BalanceResp> semifuture_balance(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::BalanceReq& p_req);
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::BalanceResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_balance(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::BalanceReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::BalanceResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_balance(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::BalanceReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::BalanceResp> co_balance(const  ::nebula::meta::cpp2::BalanceReq& p_req) {
    return co_balance<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::BalanceResp> co_balance(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::BalanceReq& p_req) {
    return co_balance<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::BalanceResp> co_balance(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::BalanceReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      balanceImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::BalanceResp _return;
    if (auto ew = recv_wrapped_balance(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void balance(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::BalanceReq& p_req);


  static folly::exception_wrapper recv_wrapped_balance( ::nebula::meta::cpp2::BalanceResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_balance( ::nebula::meta::cpp2::BalanceResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_balance( ::nebula::meta::cpp2::BalanceResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_balance( ::nebula::meta::cpp2::BalanceResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void balanceT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::BalanceReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> balanceCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
  virtual void leaderBalance(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req);
  virtual void leaderBalance(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req);
 protected:
  void leaderBalanceImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req);
 public:

  virtual void sync_leaderBalance( ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req);
  virtual void sync_leaderBalance(apache::thrift::RpcOptions& rpcOptions,  ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req);

  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_leaderBalance(const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_leaderBalance(const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req);
  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_leaderBalance(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_leaderBalance(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req);
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_leaderBalance(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_leaderBalance(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_leaderBalance(const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req) {
    return co_leaderBalance<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_leaderBalance(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req) {
    return co_leaderBalance<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_leaderBalance(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      leaderBalanceImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::ExecResp _return;
    if (auto ew = recv_wrapped_leaderBalance(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void leaderBalance(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req);


  static folly::exception_wrapper recv_wrapped_leaderBalance( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_leaderBalance( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_leaderBalance( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_leaderBalance( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void leaderBalanceT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::LeaderBalanceReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> leaderBalanceCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
 ...
 public:
  virtual void addZone(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::AddZoneReq& p_req);
  virtual void addZone(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::AddZoneReq& p_req);
 protected:
  void addZoneImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::AddZoneReq& p_req);
 public:

  virtual void sync_addZone( ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::AddZoneReq& p_req);
  virtual void sync_addZone(apache::thrift::RpcOptions& rpcOptions,  ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::AddZoneReq& p_req);

  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_addZone(const  ::nebula::meta::cpp2::AddZoneReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_addZone(const  ::nebula::meta::cpp2::AddZoneReq& p_req);
  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_addZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddZoneReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_addZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddZoneReq& p_req);
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_addZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddZoneReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_addZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddZoneReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_addZone(const  ::nebula::meta::cpp2::AddZoneReq& p_req) {
    return co_addZone<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_addZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddZoneReq& p_req) {
    return co_addZone<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_addZone(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::AddZoneReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      addZoneImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::ExecResp _return;
    if (auto ew = recv_wrapped_addZone(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void addZone(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::AddZoneReq& p_req);


  static folly::exception_wrapper recv_wrapped_addZone( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_addZone( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_addZone( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_addZone( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void addZoneT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::AddZoneReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> addZoneCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
 ...
 public:
  virtual void addHostIntoZone(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req);
  virtual void addHostIntoZone(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req);
 protected:
  void addHostIntoZoneImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req);
 public:

  virtual void sync_addHostIntoZone( ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req);
  virtual void sync_addHostIntoZone(apache::thrift::RpcOptions& rpcOptions,  ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req);

  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_addHostIntoZone(const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_addHostIntoZone(const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req);
  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_addHostIntoZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_addHostIntoZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req);
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_addHostIntoZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_addHostIntoZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_addHostIntoZone(const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req) {
    return co_addHostIntoZone<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_addHostIntoZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req) {
    return co_addHostIntoZone<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_addHostIntoZone(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      addHostIntoZoneImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::ExecResp _return;
    if (auto ew = recv_wrapped_addHostIntoZone(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void addHostIntoZone(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req);


  static folly::exception_wrapper recv_wrapped_addHostIntoZone( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_addHostIntoZone( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_addHostIntoZone( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_addHostIntoZone( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void addHostIntoZoneT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::AddHostIntoZoneReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> addHostIntoZoneCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
  virtual void dropHostFromZone(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::DropHostFromZoneReq& p_req);
  virtual void dropHostFromZone(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::DropHostFromZoneReq& p_req);
 protected:
  void dropHostFromZoneImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::DropHostFromZoneReq& p_req);
 public:

  virtual void sync_dropHostFromZone( ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::DropHostFromZoneReq& p_req);
  ...
  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_dropHostFromZone(const  ::nebula::meta::cpp2::DropHostFromZoneReq& p_req);
  ...
  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_dropHostFromZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropHostFromZoneReq& p_req);
  ...
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_dropHostFromZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropHostFromZoneReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_dropHostFromZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropHostFromZoneReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_dropHostFromZone(const  ::nebula::meta::cpp2::DropHostFromZoneReq& p_req) {
    return co_dropHostFromZone<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_dropHostFromZone(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropHostFromZoneReq& p_req) {
    return co_dropHostFromZone<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_dropHostFromZone(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::DropHostFromZoneReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      dropHostFromZoneImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::ExecResp _return;
    if (auto ew = recv_wrapped_dropHostFromZone(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void dropHostFromZone(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::DropHostFromZoneReq& p_req);


  static folly::exception_wrapper recv_wrapped_dropHostFromZone( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_dropHostFromZone( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_dropHostFromZone( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_dropHostFromZone( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void dropHostFromZoneT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::DropHostFromZoneReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> dropHostFromZoneCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
 ...
 public:
  virtual void addGroup(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::AddGroupReq& p_req);
  virtual void addGroup(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::AddGroupReq& p_req);
 protected:
  void addGroupImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::AddGroupReq& p_req);
 public:

  virtual void sync_addGroup( ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::AddGroupReq& p_req);
  virtual void sync_addGroup(apache::thrift::RpcOptions& rpcOptions,  ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::AddGroupReq& p_req);

  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_addGroup(const  ::nebula::meta::cpp2::AddGroupReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_addGroup(const  ::nebula::meta::cpp2::AddGroupReq& p_req);
  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_addGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddGroupReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_addGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddGroupReq& p_req);
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_addGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddGroupReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_addGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddGroupReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_addGroup(const  ::nebula::meta::cpp2::AddGroupReq& p_req) {
    return co_addGroup<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_addGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddGroupReq& p_req) {
    return co_addGroup<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_addGroup(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::AddGroupReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      addGroupImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::ExecResp _return;
    if (auto ew = recv_wrapped_addGroup(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void addGroup(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::AddGroupReq& p_req);


  static folly::exception_wrapper recv_wrapped_addGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_addGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_addGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_addGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void addGroupT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::AddGroupReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> addGroupCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
  virtual void dropGroup(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::DropGroupReq& p_req);
  virtual void dropGroup(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::DropGroupReq& p_req);
 protected:
  void dropGroupImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::DropGroupReq& p_req);
 public:

  virtual void sync_dropGroup( ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::DropGroupReq& p_req);
  virtual void sync_dropGroup(apache::thrift::RpcOptions& rpcOptions,  ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::DropGroupReq& p_req);

  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_dropGroup(const  ::nebula::meta::cpp2::DropGroupReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_dropGroup(const  ::nebula::meta::cpp2::DropGroupReq& p_req);
  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_dropGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropGroupReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_dropGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropGroupReq& p_req);
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_dropGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropGroupReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_dropGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropGroupReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_dropGroup(const  ::nebula::meta::cpp2::DropGroupReq& p_req) {
    return co_dropGroup<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_dropGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropGroupReq& p_req) {
    return co_dropGroup<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_dropGroup(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::DropGroupReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      dropGroupImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::ExecResp _return;
    if (auto ew = recv_wrapped_dropGroup(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void dropGroup(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::DropGroupReq& p_req);


  static folly::exception_wrapper recv_wrapped_dropGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_dropGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_dropGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_dropGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void dropGroupT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::DropGroupReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> dropGroupCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
  virtual void addZoneIntoGroup(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req);
  virtual void addZoneIntoGroup(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req);
 protected:
  void addZoneIntoGroupImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req);
 public:

  virtual void sync_addZoneIntoGroup( ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req);
  virtual void sync_addZoneIntoGroup(apache::thrift::RpcOptions& rpcOptions,  ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req);

  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_addZoneIntoGroup(const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_addZoneIntoGroup(const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req);
  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_addZoneIntoGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_addZoneIntoGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req);
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_addZoneIntoGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_addZoneIntoGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_addZoneIntoGroup(const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req) {
    return co_addZoneIntoGroup<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_addZoneIntoGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req) {
    return co_addZoneIntoGroup<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_addZoneIntoGroup(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      addZoneIntoGroupImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::ExecResp _return;
    if (auto ew = recv_wrapped_addZoneIntoGroup(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void addZoneIntoGroup(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req);


  static folly::exception_wrapper recv_wrapped_addZoneIntoGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_addZoneIntoGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_addZoneIntoGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_addZoneIntoGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void addZoneIntoGroupT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::AddZoneIntoGroupReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> addZoneIntoGroupCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
  virtual void dropZoneFromGroup(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req);
  virtual void dropZoneFromGroup(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req);
 protected:
  void dropZoneFromGroupImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req);
 public:

  virtual void sync_dropZoneFromGroup( ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req);
  virtual void sync_dropZoneFromGroup(apache::thrift::RpcOptions& rpcOptions,  ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req);

  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_dropZoneFromGroup(const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_dropZoneFromGroup(const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req);
  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_dropZoneFromGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_dropZoneFromGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req);
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_dropZoneFromGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_dropZoneFromGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_dropZoneFromGroup(const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req) {
    return co_dropZoneFromGroup<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_dropZoneFromGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req) {
    return co_dropZoneFromGroup<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_dropZoneFromGroup(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      dropZoneFromGroupImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::ExecResp _return;
    if (auto ew = recv_wrapped_dropZoneFromGroup(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void dropZoneFromGroup(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req);


  static folly::exception_wrapper recv_wrapped_dropZoneFromGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_dropZoneFromGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_dropZoneFromGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_dropZoneFromGroup( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void dropZoneFromGroupT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::DropZoneFromGroupReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> dropZoneFromGroupCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
  virtual void getGroup(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::GetGroupReq& p_req);
  virtual void getGroup(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::GetGroupReq& p_req);
 protected:
  void getGroupImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::GetGroupReq& p_req);
 public:

  virtual void sync_getGroup( ::nebula::meta::cpp2::GetGroupResp& _return, const  ::nebula::meta::cpp2::GetGroupReq& p_req);
  virtual void sync_getGroup(apache::thrift::RpcOptions& rpcOptions,  ::nebula::meta::cpp2::GetGroupResp& _return, const  ::nebula::meta::cpp2::GetGroupReq& p_req);

  virtual folly::Future< ::nebula::meta::cpp2::GetGroupResp> future_getGroup(const  ::nebula::meta::cpp2::GetGroupReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::GetGroupResp> semifuture_getGroup(const  ::nebula::meta::cpp2::GetGroupReq& p_req);
  virtual folly::Future< ::nebula::meta::cpp2::GetGroupResp> future_getGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::GetGroupReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::GetGroupResp> semifuture_getGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::GetGroupReq& p_req);
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::GetGroupResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_getGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::GetGroupReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::GetGroupResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_getGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::GetGroupReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::GetGroupResp> co_getGroup(const  ::nebula::meta::cpp2::GetGroupReq& p_req) {
    return co_getGroup<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::GetGroupResp> co_getGroup(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::GetGroupReq& p_req) {
    return co_getGroup<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::GetGroupResp> co_getGroup(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::GetGroupReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      getGroupImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::GetGroupResp _return;
    if (auto ew = recv_wrapped_getGroup(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void getGroup(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::GetGroupReq& p_req);


  static folly::exception_wrapper recv_wrapped_getGroup( ::nebula::meta::cpp2::GetGroupResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_getGroup( ::nebula::meta::cpp2::GetGroupResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_getGroup( ::nebula::meta::cpp2::GetGroupResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_getGroup( ::nebula::meta::cpp2::GetGroupResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void getGroupT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::GetGroupReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> getGroupCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
  virtual void listGroups(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::ListGroupsReq& p_req);
  virtual void listGroups(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::ListGroupsReq& p_req);
 protected:
  void listGroupsImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::ListGroupsReq& p_req);
 public:

  virtual void sync_listGroups( ::nebula::meta::cpp2::ListGroupsResp& _return, const  ::nebula::meta::cpp2::ListGroupsReq& p_req);
  virtual void sync_listGroups(apache::thrift::RpcOptions& rpcOptions,  ::nebula::meta::cpp2::ListGroupsResp& _return, const  ::nebula::meta::cpp2::ListGroupsReq& p_req);

  virtual folly::Future< ::nebula::meta::cpp2::ListGroupsResp> future_listGroups(const  ::nebula::meta::cpp2::ListGroupsReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ListGroupsResp> semifuture_listGroups(const  ::nebula::meta::cpp2::ListGroupsReq& p_req);
  virtual folly::Future< ::nebula::meta::cpp2::ListGroupsResp> future_listGroups(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::ListGroupsReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ListGroupsResp> semifuture_listGroups(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::ListGroupsReq& p_req);
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::ListGroupsResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_listGroups(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::ListGroupsReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::ListGroupsResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_listGroups(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::ListGroupsReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ListGroupsResp> co_listGroups(const  ::nebula::meta::cpp2::ListGroupsReq& p_req) {
    return co_listGroups<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ListGroupsResp> co_listGroups(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::ListGroupsReq& p_req) {
    return co_listGroups<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::ListGroupsResp> co_listGroups(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::ListGroupsReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      listGroupsImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::ListGroupsResp _return;
    if (auto ew = recv_wrapped_listGroups(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void listGroups(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::ListGroupsReq& p_req);


  static folly::exception_wrapper recv_wrapped_listGroups( ::nebula::meta::cpp2::ListGroupsResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_listGroups( ::nebula::meta::cpp2::ListGroupsResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_listGroups( ::nebula::meta::cpp2::ListGroupsResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_listGroups( ::nebula::meta::cpp2::ListGroupsResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void listGroupsT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::ListGroupsReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> listGroupsCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
 ...
 public:
  virtual void signInFTService(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req);
  virtual void signInFTService(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req);
 protected:
  void signInFTServiceImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req);
 public:

  virtual void sync_signInFTService( ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req);
  virtual void sync_signInFTService(apache::thrift::RpcOptions& rpcOptions,  ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req);

  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_signInFTService(const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_signInFTService(const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req);
  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_signInFTService(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_signInFTService(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req);
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_signInFTService(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_signInFTService(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_signInFTService(const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req) {
    return co_signInFTService<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_signInFTService(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req) {
    return co_signInFTService<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_signInFTService(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      signInFTServiceImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::ExecResp _return;
    if (auto ew = recv_wrapped_signInFTService(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void signInFTService(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req);


  static folly::exception_wrapper recv_wrapped_signInFTService( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_signInFTService( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_signInFTService( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_signInFTService( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void signInFTServiceT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::SignInFTServiceReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> signInFTServiceCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
  virtual void signOutFTService(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req);
  virtual void signOutFTService(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req);
 protected:
  void signOutFTServiceImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req);
 public:

  virtual void sync_signOutFTService( ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req);
  virtual void sync_signOutFTService(apache::thrift::RpcOptions& rpcOptions,  ::nebula::meta::cpp2::ExecResp& _return, const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req);

  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_signOutFTService(const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_signOutFTService(const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req);
  virtual folly::Future< ::nebula::meta::cpp2::ExecResp> future_signOutFTService(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ExecResp> semifuture_signOutFTService(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req);
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_signOutFTService(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::ExecResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_signOutFTService(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_signOutFTService(const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req) {
    return co_signOutFTService<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_signOutFTService(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req) {
    return co_signOutFTService<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::ExecResp> co_signOutFTService(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      signOutFTServiceImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::ExecResp _return;
    if (auto ew = recv_wrapped_signOutFTService(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void signOutFTService(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req);


  static folly::exception_wrapper recv_wrapped_signOutFTService( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_signOutFTService( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_signOutFTService( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_signOutFTService( ::nebula::meta::cpp2::ExecResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void signOutFTServiceT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::SignOutFTServiceReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> signOutFTServiceCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
  virtual void listFTClients(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::ListFTClientsReq& p_req);
  virtual void listFTClients(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::meta::cpp2::ListFTClientsReq& p_req);
 protected:
  void listFTClientsImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::ListFTClientsReq& p_req);
 public:

  virtual void sync_listFTClients( ::nebula::meta::cpp2::ListFTClientsResp& _return, const  ::nebula::meta::cpp2::ListFTClientsReq& p_req);
  virtual void sync_listFTClients(apache::thrift::RpcOptions& rpcOptions,  ::nebula::meta::cpp2::ListFTClientsResp& _return, const  ::nebula::meta::cpp2::ListFTClientsReq& p_req);

  virtual folly::Future< ::nebula::meta::cpp2::ListFTClientsResp> future_listFTClients(const  ::nebula::meta::cpp2::ListFTClientsReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ListFTClientsResp> semifuture_listFTClients(const  ::nebula::meta::cpp2::ListFTClientsReq& p_req);
  virtual folly::Future< ::nebula::meta::cpp2::ListFTClientsResp> future_listFTClients(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::ListFTClientsReq& p_req);
  virtual folly::SemiFuture< ::nebula::meta::cpp2::ListFTClientsResp> semifuture_listFTClients(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::ListFTClientsReq& p_req);
  virtual folly::Future<std::pair< ::nebula::meta::cpp2::ListFTClientsResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_listFTClients(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::ListFTClientsReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::meta::cpp2::ListFTClientsResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_listFTClients(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::ListFTClientsReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ListFTClientsResp> co_listFTClients(const  ::nebula::meta::cpp2::ListFTClientsReq& p_req) {
    return co_listFTClients<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::meta::cpp2::ListFTClientsResp> co_listFTClients(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::meta::cpp2::ListFTClientsReq& p_req) {
    return co_listFTClients<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::meta::cpp2::ListFTClientsResp> co_listFTClients(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::meta::cpp2::ListFTClientsReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      listFTClientsImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::meta::cpp2::ListFTClientsResp _return;
    if (auto ew = recv_wrapped_listFTClients(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void listFTClients(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::meta::cpp2::ListFTClientsReq& p_req);


  static folly::exception_wrapper recv_wrapped_listFTClients( ::nebula::meta::cpp2::ListFTClientsResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_listFTClients( ::nebula::meta::cpp2::ListFTClientsResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_listFTClients( ::nebula::meta::cpp2::ListFTClientsResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_listFTClients( ::nebula::meta::cpp2::ListFTClientsResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void listFTClientsT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::meta::cpp2::ListFTClientsReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> listFTClientsCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
