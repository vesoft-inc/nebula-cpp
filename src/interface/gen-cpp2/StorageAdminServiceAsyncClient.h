...
class StorageAdminServiceAsyncClient : public apache::thrift::GeneratedAsyncClient {
 ...
 public:
  virtual void listClusterInfo(std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req);
  virtual void listClusterInfo(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req);
 protected:
  void listClusterInfoImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req);
 public:

  virtual void sync_listClusterInfo( ::nebula::storage::cpp2::ListClusterInfoResp& _return, const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req);
  virtual void sync_listClusterInfo(apache::thrift::RpcOptions& rpcOptions,  ::nebula::storage::cpp2::ListClusterInfoResp& _return, const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req);

  virtual folly::Future< ::nebula::storage::cpp2::ListClusterInfoResp> future_listClusterInfo(const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req);
  virtual folly::SemiFuture< ::nebula::storage::cpp2::ListClusterInfoResp> semifuture_listClusterInfo(const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req);
  virtual folly::Future< ::nebula::storage::cpp2::ListClusterInfoResp> future_listClusterInfo(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req);
  virtual folly::SemiFuture< ::nebula::storage::cpp2::ListClusterInfoResp> semifuture_listClusterInfo(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req);
  virtual folly::Future<std::pair< ::nebula::storage::cpp2::ListClusterInfoResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_future_listClusterInfo(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req);
  virtual folly::SemiFuture<std::pair< ::nebula::storage::cpp2::ListClusterInfoResp, std::unique_ptr<apache::thrift::transport::THeader>>> header_semifuture_listClusterInfo(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req);

#if FOLLY_HAS_COROUTINES
  template <int = 0>
  folly::coro::Task< ::nebula::storage::cpp2::ListClusterInfoResp> co_listClusterInfo(const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req) {
    return co_listClusterInfo<false>(nullptr, p_req);
  }
  template <int = 0>
  folly::coro::Task< ::nebula::storage::cpp2::ListClusterInfoResp> co_listClusterInfo(apache::thrift::RpcOptions& rpcOptions, const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req) {
    return co_listClusterInfo<true>(&rpcOptions, p_req);
  }
 private:
  template <bool hasRpcOptions>
  folly::coro::Task< ::nebula::storage::cpp2::ListClusterInfoResp> co_listClusterInfo(apache::thrift::RpcOptions* rpcOptions, const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      listClusterInfoImpl(defaultRpcOptions, ctx, std::move(wrappedCallback), p_req);
    }
    if (cancellable) {
      folly::CancellationCallback cb(cancelToken, [&] { CancellableCallback::cancel(std::move(cancellableCallback)); });
      co_await callback.co_waitUntilDone();
    ...
    SCOPE_EXIT {
     ...
     ::nebula::storage::cpp2::ListClusterInfoResp _return;
    if (auto ew = recv_wrapped_listClusterInfo(_return, returnState)) {
      co_yield folly::coro::co_error(std::move(ew));
    }
    co_return _return;
  }
 public:
  ...
  virtual void listClusterInfo(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req);


  static folly::exception_wrapper recv_wrapped_listClusterInfo( ::nebula::storage::cpp2::ListClusterInfoResp& _return, ::apache::thrift::ClientReceiveState& state);
  static void recv_listClusterInfo( ::nebula::storage::cpp2::ListClusterInfoResp& _return, ::apache::thrift::ClientReceiveState& state);
  // Mock friendly virtual instance method
  virtual void recv_instance_listClusterInfo( ::nebula::storage::cpp2::ListClusterInfoResp& _return, ::apache::thrift::ClientReceiveState& state);
  virtual folly::exception_wrapper recv_instance_wrapped_listClusterInfo( ::nebula::storage::cpp2::ListClusterInfoResp& _return, ::apache::thrift::ClientReceiveState& state);
 private:
  template <typename Protocol_>
  void listClusterInfoT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, const  ::nebula::storage::cpp2::ListClusterInfoReq& p_req);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> listClusterInfoCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
};
