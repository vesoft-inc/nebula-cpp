...
template <>
struct TccStructTraits<::nebula::storage::cpp2::ScanVertexResponse> {
  static void translateFieldName(
      folly::StringPiece _fname,
      int16_t& fid,
      apache::thrift::protocol::TType& _ftype) noexcept;
...
template <>
struct TccStructTraits<::nebula::storage::cpp2::ScanEdgeResponse> {
  static void translateFieldName(
      folly::StringPiece _fname,
      int16_t& fid,
      apache::thrift::protocol::TType& _ftype) noexcept;
...
template <>
struct TccStructTraits<::nebula::storage::cpp2::InternalTxnRequest> {
  static void translateFieldName(
      folly::StringPiece _fname,
      int16_t& fid,
      apache::thrift::protocol::TType& _ftype) noexcept;
...
_readField_cursor:
  {
    ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::binary, ::std::string>::readWithContext(*iprot, this->cursor, _readState);
    THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
...
_readField_return_columns:
  {
    _readState.beforeSubobject(iprot);
    ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::VertexProp>::readWithContext(*iprot, this->return_columns, _readState);
    THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
    this->__isset.return_columns = true;
    THRIFT_IGNORE_ISSET_USE_WARNING_END
    _readState.afterSubobject(iprot);
...
uint32_t ScanVertexRequest::serializedSize(Protocol_ const* prot_) const {
  ...
  xfer += prot_->serializedFieldSize("part_id", apache::thrift::protocol::T_I32, 2);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral,  ::nebula::cpp2::PartitionID>::serializedSize<false>(*prot_, this->part_id);
  if (this->cursor_ref().has_value()) {
    xfer += prot_->serializedFieldSize("cursor", apache::thrift::protocol::T_STRING, 3);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::binary, ::std::string>::serializedSize<false>(*prot_, this->cursor);
  }
  xfer += prot_->serializedFieldSize("return_columns", apache::thrift::protocol::T_STRUCT, 4);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::VertexProp>::serializedSize<false>(*prot_, this->return_columns);
  xfer += prot_->serializedFieldSize("limit", apache::thrift::protocol::T_I64, 5);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, int64_t>::serializedSize<false>(*prot_, this->limit);
  if (this->start_time_ref().has_value()) {
    xfer += prot_->serializedFieldSize("start_time", apache::thrift::protocol::T_I64, 6);
  ...
  if (this->end_time_ref().has_value()) {
    xfer += prot_->serializedFieldSize("end_time", apache::thrift::protocol::T_I64, 7);
  ...
  if (this->filter_ref().has_value()) {
    xfer += prot_->serializedFieldSize("filter", apache::thrift::protocol::T_STRING, 8);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::binary, ::std::string>::serializedSize<false>(*prot_, this->filter);
  }
  xfer += prot_->serializedFieldSize("only_latest_version", apache::thrift::protocol::T_BOOL, 9);
  ...
  xfer += prot_->serializedFieldSize("enable_read_from_follower", apache::thrift::protocol::T_BOOL, 10);
  ...
  if (this->common_ref().has_value()) {
    xfer += prot_->serializedFieldSize("common", apache::thrift::protocol::T_STRUCT, 11);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::RequestCommon>::serializedSize<false>(*prot_, this->common);
  }
  xfer += prot_->serializedSizeStop();
  return xfer;
...
uint32_t ScanVertexRequest::serializedSizeZC(Protocol_ const* prot_) const {
  ...
  if (this->cursor_ref().has_value()) {
    xfer += prot_->serializedFieldSize("cursor", apache::thrift::protocol::T_STRING, 3);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::binary, ::std::string>::serializedSize<true>(*prot_, this->cursor);
  }
  xfer += prot_->serializedFieldSize("return_columns", apache::thrift::protocol::T_STRUCT, 4);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::VertexProp>::serializedSize<true>(*prot_, this->return_columns);
  xfer += prot_->serializedFieldSize("limit", apache::thrift::protocol::T_I64, 5);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, int64_t>::serializedSize<false>(*prot_, this->limit);
  if (this->start_time_ref().has_value()) {
    xfer += prot_->serializedFieldSize("start_time", apache::thrift::protocol::T_I64, 6);
...
uint32_t ScanVertexRequest::write(Protocol_* prot_) const {
  ...
  xfer += prot_->writeFieldEnd();
  if (this->cursor_ref().has_value()) {
    xfer += prot_->writeFieldBegin("cursor", apache::thrift::protocol::T_STRING, 3);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::binary, ::std::string>::write(*prot_, this->cursor);
    xfer += prot_->writeFieldEnd();
  }
  xfer += prot_->writeFieldBegin("return_columns", apache::thrift::protocol::T_STRUCT, 4);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::VertexProp>::write(*prot_, this->return_columns);
  xfer += prot_->writeFieldEnd();
  xfer += prot_->writeFieldBegin("limit", apache::thrift::protocol::T_I64, 5);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, int64_t>::write(*prot_, this->limit);
  xfer += prot_->writeFieldEnd();
  if (this->start_time_ref().has_value()) {
    xfer += prot_->writeFieldBegin("start_time", apache::thrift::protocol::T_I64, 6);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, int64_t>::write(*prot_, this->start_time);
    xfer += prot_->writeFieldEnd();
  }
  if (this->end_time_ref().has_value()) {
    xfer += prot_->writeFieldBegin("end_time", apache::thrift::protocol::T_I64, 7);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, int64_t>::write(*prot_, this->end_time);
    xfer += prot_->writeFieldEnd();
  }
  if (this->filter_ref().has_value()) {
    xfer += prot_->writeFieldBegin("filter", apache::thrift::protocol::T_STRING, 8);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::binary, ::std::string>::write(*prot_, this->filter);
    xfer += prot_->writeFieldEnd();
  }
  xfer += prot_->writeFieldBegin("only_latest_version", apache::thrift::protocol::T_BOOL, 9);
  ...
  xfer += prot_->writeFieldEnd();
  xfer += prot_->writeFieldBegin("enable_read_from_follower", apache::thrift::protocol::T_BOOL, 10);
  ...
  xfer += prot_->writeFieldEnd();
  if (this->common_ref().has_value()) {
    xfer += prot_->writeFieldBegin("common", apache::thrift::protocol::T_STRUCT, 11);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::RequestCommon>::write(*prot_, this->common);
    xfer += prot_->writeFieldEnd();
  }
  xfer += prot_->writeFieldStop();
...
template <class Protocol_>
void ScanVertexResponse::readNoXfer(Protocol_* iprot) {
  apache::thrift::detail::ProtocolReaderStructReadState<Protocol_> _readState;
...
_readField_vertex_data:
  {
    _readState.beforeSubobject(iprot);
    ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure, nebula::DataSet>::readWithContext(*iprot, this->vertex_data, _readState);
    THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
...
_loop:
  ...
  if (iprot->kUsesFieldNames()) {
    _readState.template fillFieldTraitsFromName<apache::thrift::detail::TccStructTraits<ScanVertexResponse>>();
  }
...
template <class Protocol_>
uint32_t ScanVertexResponse::serializedSize(Protocol_ const* prot_) const {
  uint32_t xfer = 0;
  xfer += prot_->serializedStructSize("ScanVertexResponse");
  xfer += prot_->serializedFieldSize("result", apache::thrift::protocol::T_STRUCT, 1);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::ResponseCommon>::serializedSize<false>(*prot_, this->result);
  xfer += prot_->serializedFieldSize("vertex_data", apache::thrift::protocol::T_STRUCT, 2);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure, nebula::DataSet>::serializedSize<false>(*prot_, this->vertex_data);
...
template <class Protocol_>
uint32_t ScanVertexResponse::serializedSizeZC(Protocol_ const* prot_) const {
  uint32_t xfer = 0;
  xfer += prot_->serializedStructSize("ScanVertexResponse");
  xfer += prot_->serializedFieldSize("result", apache::thrift::protocol::T_STRUCT, 1);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::ResponseCommon>::serializedSize<true>(*prot_, this->result);
  xfer += prot_->serializedFieldSize("vertex_data", apache::thrift::protocol::T_STRUCT, 2);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure, nebula::DataSet>::serializedSize<true>(*prot_, this->vertex_data);
  xfer += prot_->serializedFieldSize("has_next", apache::thrift::protocol::T_BOOL, 3);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, bool>::serializedSize<false>(*prot_, this->has_next);
  if (this->next_cursor_ref().has_value()) {
    xfer += prot_->serializedFieldSize("next_cursor", apache::thrift::protocol::T_STRING, 4);
...
template <class Protocol_>
uint32_t ScanVertexResponse::write(Protocol_* prot_) const {
  uint32_t xfer = 0;
  xfer += prot_->writeStructBegin("ScanVertexResponse");
  xfer += prot_->writeFieldBegin("result", apache::thrift::protocol::T_STRUCT, 1);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::ResponseCommon>::write(*prot_, this->result);
  xfer += prot_->writeFieldEnd();
  xfer += prot_->writeFieldBegin("vertex_data", apache::thrift::protocol::T_STRUCT, 2);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure, nebula::DataSet>::write(*prot_, this->vertex_data);
  xfer += prot_->writeFieldEnd();
...
extern template void ScanVertexResponse::readNoXfer<>(apache::thrift::BinaryProtocolReader*);
extern template uint32_t ScanVertexResponse::write<>(apache::thrift::BinaryProtocolWriter*) const;
extern template uint32_t ScanVertexResponse::serializedSize<>(apache::thrift::BinaryProtocolWriter const*) const;
extern template uint32_t ScanVertexResponse::serializedSizeZC<>(apache::thrift::BinaryProtocolWriter const*) const;
extern template void ScanVertexResponse::readNoXfer<>(apache::thrift::CompactProtocolReader*);
extern template uint32_t ScanVertexResponse::write<>(apache::thrift::CompactProtocolWriter*) const;
extern template uint32_t ScanVertexResponse::serializedSize<>(apache::thrift::CompactProtocolWriter const*) const;
extern template uint32_t ScanVertexResponse::serializedSizeZC<>(apache::thrift::CompactProtocolWriter const*) const;
...
_readField_return_columns:
  {
    _readState.beforeSubobject(iprot);
    ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::EdgeProp>::readWithContext(*iprot, this->return_columns, _readState);
    THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
    this->__isset.return_columns = true;
    THRIFT_IGNORE_ISSET_USE_WARNING_END
    _readState.afterSubobject(iprot);
...
uint32_t ScanEdgeRequest::serializedSize(Protocol_ const* prot_) const {
  ...
  xfer += prot_->serializedFieldSize("return_columns", apache::thrift::protocol::T_STRUCT, 4);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::EdgeProp>::serializedSize<false>(*prot_, this->return_columns);
  xfer += prot_->serializedFieldSize("limit", apache::thrift::protocol::T_I64, 5);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, int64_t>::serializedSize<false>(*prot_, this->limit);
  if (this->start_time_ref().has_value()) {
    xfer += prot_->serializedFieldSize("start_time", apache::thrift::protocol::T_I64, 6);
...
uint32_t ScanEdgeRequest::serializedSizeZC(Protocol_ const* prot_) const {
  ...
  xfer += prot_->serializedFieldSize("return_columns", apache::thrift::protocol::T_STRUCT, 4);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::EdgeProp>::serializedSize<true>(*prot_, this->return_columns);
  xfer += prot_->serializedFieldSize("limit", apache::thrift::protocol::T_I64, 5);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, int64_t>::serializedSize<false>(*prot_, this->limit);
  if (this->start_time_ref().has_value()) {
    xfer += prot_->serializedFieldSize("start_time", apache::thrift::protocol::T_I64, 6);
...
uint32_t ScanEdgeRequest::write(Protocol_* prot_) const {
  ...
  xfer += prot_->writeFieldBegin("return_columns", apache::thrift::protocol::T_STRUCT, 4);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::EdgeProp>::write(*prot_, this->return_columns);
  xfer += prot_->writeFieldEnd();
  xfer += prot_->writeFieldBegin("limit", apache::thrift::protocol::T_I64, 5);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, int64_t>::write(*prot_, this->limit);
  xfer += prot_->writeFieldEnd();
...
template <class Protocol_>
void ScanEdgeResponse::readNoXfer(Protocol_* iprot) {
  apache::thrift::detail::ProtocolReaderStructReadState<Protocol_> _readState;
...
_readField_edge_data:
  {
    _readState.beforeSubobject(iprot);
    ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure, nebula::DataSet>::readWithContext(*iprot, this->edge_data, _readState);
    THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
...
_loop:
  ...
  if (iprot->kUsesFieldNames()) {
    _readState.template fillFieldTraitsFromName<apache::thrift::detail::TccStructTraits<ScanEdgeResponse>>();
  }
...
template <class Protocol_>
uint32_t ScanEdgeResponse::serializedSize(Protocol_ const* prot_) const {
  uint32_t xfer = 0;
  xfer += prot_->serializedStructSize("ScanEdgeResponse");
  xfer += prot_->serializedFieldSize("result", apache::thrift::protocol::T_STRUCT, 1);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::ResponseCommon>::serializedSize<false>(*prot_, this->result);
  xfer += prot_->serializedFieldSize("edge_data", apache::thrift::protocol::T_STRUCT, 2);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure, nebula::DataSet>::serializedSize<false>(*prot_, this->edge_data);
  xfer += prot_->serializedFieldSize("has_next", apache::thrift::protocol::T_BOOL, 3);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, bool>::serializedSize<false>(*prot_, this->has_next);
  if (this->next_cursor_ref().has_value()) {
    xfer += prot_->serializedFieldSize("next_cursor", apache::thrift::protocol::T_STRING, 4);
...
template <class Protocol_>
uint32_t ScanEdgeResponse::serializedSizeZC(Protocol_ const* prot_) const {
  uint32_t xfer = 0;
  xfer += prot_->serializedStructSize("ScanEdgeResponse");
  xfer += prot_->serializedFieldSize("result", apache::thrift::protocol::T_STRUCT, 1);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::ResponseCommon>::serializedSize<true>(*prot_, this->result);
  xfer += prot_->serializedFieldSize("edge_data", apache::thrift::protocol::T_STRUCT, 2);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure, nebula::DataSet>::serializedSize<true>(*prot_, this->edge_data);
  xfer += prot_->serializedFieldSize("has_next", apache::thrift::protocol::T_BOOL, 3);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, bool>::serializedSize<false>(*prot_, this->has_next);
  if (this->next_cursor_ref().has_value()) {
    xfer += prot_->serializedFieldSize("next_cursor", apache::thrift::protocol::T_STRING, 4);
...
template <class Protocol_>
uint32_t ScanEdgeResponse::write(Protocol_* prot_) const {
  uint32_t xfer = 0;
  xfer += prot_->writeStructBegin("ScanEdgeResponse");
  xfer += prot_->writeFieldBegin("result", apache::thrift::protocol::T_STRUCT, 1);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::ResponseCommon>::write(*prot_, this->result);
  xfer += prot_->writeFieldEnd();
  xfer += prot_->writeFieldBegin("edge_data", apache::thrift::protocol::T_STRUCT, 2);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure, nebula::DataSet>::write(*prot_, this->edge_data);
  xfer += prot_->writeFieldEnd();
  xfer += prot_->writeFieldBegin("has_next", apache::thrift::protocol::T_BOOL, 3);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, bool>::write(*prot_, this->has_next);
  xfer += prot_->writeFieldEnd();
...
extern template void ScanEdgeResponse::readNoXfer<>(apache::thrift::BinaryProtocolReader*);
extern template uint32_t ScanEdgeResponse::write<>(apache::thrift::BinaryProtocolWriter*) const;
extern template uint32_t ScanEdgeResponse::serializedSize<>(apache::thrift::BinaryProtocolWriter const*) const;
extern template uint32_t ScanEdgeResponse::serializedSizeZC<>(apache::thrift::BinaryProtocolWriter const*) const;
extern template void ScanEdgeResponse::readNoXfer<>(apache::thrift::CompactProtocolReader*);
extern template uint32_t ScanEdgeResponse::write<>(apache::thrift::CompactProtocolWriter*) const;
extern template uint32_t ScanEdgeResponse::serializedSize<>(apache::thrift::CompactProtocolWriter const*) const;
extern template uint32_t ScanEdgeResponse::serializedSizeZC<>(apache::thrift::CompactProtocolWriter const*) const;
...
_readField_task_specfic_paras:
  {
    _readState.beforeSubobject(iprot);
    this->task_specfic_paras = ::std::vector<::std::string>();
    ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::list<::apache::thrift::type_class::binary>, ::std::vector<::std::string>>::readWithContext(*iprot, this->task_specfic_paras, _readState);
    THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
...
_loop:
  ...
  switch (_readState.fieldId) {
    ...
    {
      if (LIKELY(_readState.isCompatibleWithType(iprot, apache::thrift::protocol::T_LIST))) {
        goto _readField_task_specfic_paras;
      } else {
        goto _skip;
      }
    }
...
uint32_t TaskPara::serializedSize(Protocol_ const* prot_) const {
  ...
  if (this->task_specfic_paras_ref().has_value()) {
    xfer += prot_->serializedFieldSize("task_specfic_paras", apache::thrift::protocol::T_LIST, 3);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::list<::apache::thrift::type_class::binary>, ::std::vector<::std::string>>::serializedSize<false>(*prot_, this->task_specfic_paras);
  }
  xfer += prot_->serializedSizeStop();
  return xfer;
}
...
uint32_t TaskPara::write(Protocol_* prot_) const {
  ...
  if (this->task_specfic_paras_ref().has_value()) {
    xfer += prot_->writeFieldBegin("task_specfic_paras", apache::thrift::protocol::T_LIST, 3);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::list<::apache::thrift::type_class::binary>, ::std::vector<::std::string>>::write(*prot_, this->task_specfic_paras);
    xfer += prot_->writeFieldEnd();
  }
  xfer += prot_->writeFieldStop();
  xfer += prot_->writeStructEnd();
...
template <class Protocol_>
void InternalTxnRequest::readNoXfer(Protocol_* iprot) {
  apache::thrift::detail::ProtocolReaderStructReadState<Protocol_> _readState;
...
_readField_term_of_parts:
  {
    _readState.beforeSubobject(iprot);
    this->term_of_parts = ::std::map< ::nebula::cpp2::PartitionID, int64_t>();
    ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::map<::apache::thrift::type_class::integral, ::apache::thrift::type_class::integral>, ::std::map< ::nebula::cpp2::PartitionID, int64_t>>::readWithContext(*iprot, this->term_of_parts, _readState);
    THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
    this->__isset.term_of_parts = true;
    THRIFT_IGNORE_ISSET_USE_WARNING_END
    _readState.afterSubobject(iprot);
  }
...
_readField_add_edge_req:
  {
    _readState.beforeSubobject(iprot);
    ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::AddEdgesRequest>::readWithContext(*iprot, this->add_edge_req, _readState);
    THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
    this->__isset.add_edge_req = true;
    THRIFT_IGNORE_ISSET_USE_WARNING_END
    _readState.afterSubobject(iprot);
  }
...
_readField_upd_edge_req:
  {
    _readState.beforeSubobject(iprot);
    ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::UpdateEdgeRequest>::readWithContext(*iprot, this->upd_edge_req, _readState);
    THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
    this->__isset.upd_edge_req = true;
    THRIFT_IGNORE_ISSET_USE_WARNING_END
    _readState.afterSubobject(iprot);
  }
...
_readField_edge_ver:
  {
    _readState.beforeSubobject(iprot);
    this->edge_ver = std::unordered_map< ::nebula::cpp2::PartitionID, ::std::vector<int64_t>>();
    ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::map<::apache::thrift::type_class::integral, ::apache::thrift::type_class::list<::apache::thrift::type_class::integral>>, std::unordered_map< ::nebula::cpp2::PartitionID, ::std::vector<int64_t>>>::readWithContext(*iprot, this->edge_ver, _readState);
    THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
    this->__isset.edge_ver = true;
    THRIFT_IGNORE_ISSET_USE_WARNING_END
    _readState.afterSubobject(iprot);
  }
...
_loop:
  ...
  if (iprot->kUsesFieldNames()) {
    _readState.template fillFieldTraitsFromName<apache::thrift::detail::TccStructTraits<InternalTxnRequest>>();
  }
...
template <class Protocol_>
uint32_t InternalTxnRequest::serializedSize(Protocol_ const* prot_) const {
  uint32_t xfer = 0;
  xfer += prot_->serializedStructSize("InternalTxnRequest");
  xfer += prot_->serializedFieldSize("txn_id", apache::thrift::protocol::T_I64, 1);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, int64_t>::serializedSize<false>(*prot_, this->txn_id);
  xfer += prot_->serializedFieldSize("term_of_parts", apache::thrift::protocol::T_MAP, 2);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::map<::apache::thrift::type_class::integral, ::apache::thrift::type_class::integral>, ::std::map< ::nebula::cpp2::PartitionID, int64_t>>::serializedSize<false>(*prot_, this->term_of_parts);
  if (this->add_edge_req_ref().has_value()) {
    xfer += prot_->serializedFieldSize("add_edge_req", apache::thrift::protocol::T_STRUCT, 3);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::AddEdgesRequest>::serializedSize<false>(*prot_, this->add_edge_req);
  }
  if (this->upd_edge_req_ref().has_value()) {
    xfer += prot_->serializedFieldSize("upd_edge_req", apache::thrift::protocol::T_STRUCT, 4);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::UpdateEdgeRequest>::serializedSize<false>(*prot_, this->upd_edge_req);
  }
  if (this->edge_ver_ref().has_value()) {
    xfer += prot_->serializedFieldSize("edge_ver", apache::thrift::protocol::T_MAP, 5);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::map<::apache::thrift::type_class::integral, ::apache::thrift::type_class::list<::apache::thrift::type_class::integral>>, std::unordered_map< ::nebula::cpp2::PartitionID, ::std::vector<int64_t>>>::serializedSize<false>(*prot_, this->edge_ver);
  }
  xfer += prot_->serializedSizeStop();
  return xfer;
}
...
template <class Protocol_>
uint32_t InternalTxnRequest::serializedSizeZC(Protocol_ const* prot_) const {
  uint32_t xfer = 0;
  xfer += prot_->serializedStructSize("InternalTxnRequest");
  xfer += prot_->serializedFieldSize("txn_id", apache::thrift::protocol::T_I64, 1);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, int64_t>::serializedSize<false>(*prot_, this->txn_id);
  ...
  if (this->add_edge_req_ref().has_value()) {
    xfer += prot_->serializedFieldSize("add_edge_req", apache::thrift::protocol::T_STRUCT, 3);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::AddEdgesRequest>::serializedSize<true>(*prot_, this->add_edge_req);
  }
  if (this->upd_edge_req_ref().has_value()) {
    xfer += prot_->serializedFieldSize("upd_edge_req", apache::thrift::protocol::T_STRUCT, 4);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::UpdateEdgeRequest>::serializedSize<true>(*prot_, this->upd_edge_req);
  }
  if (this->edge_ver_ref().has_value()) {
    xfer += prot_->serializedFieldSize("edge_ver", apache::thrift::protocol::T_MAP, 5);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::map<::apache::thrift::type_class::integral, ::apache::thrift::type_class::list<::apache::thrift::type_class::integral>>, std::unordered_map< ::nebula::cpp2::PartitionID, ::std::vector<int64_t>>>::serializedSize<false>(*prot_, this->edge_ver);
...
template <class Protocol_>
uint32_t InternalTxnRequest::write(Protocol_* prot_) const {
  uint32_t xfer = 0;
  xfer += prot_->writeStructBegin("InternalTxnRequest");
  xfer += prot_->writeFieldBegin("txn_id", apache::thrift::protocol::T_I64, 1);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, int64_t>::write(*prot_, this->txn_id);
  xfer += prot_->writeFieldEnd();
  xfer += prot_->writeFieldBegin("term_of_parts", apache::thrift::protocol::T_MAP, 2);
  xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::map<::apache::thrift::type_class::integral, ::apache::thrift::type_class::integral>, ::std::map< ::nebula::cpp2::PartitionID, int64_t>>::write(*prot_, this->term_of_parts);
  xfer += prot_->writeFieldEnd();
  if (this->add_edge_req_ref().has_value()) {
    xfer += prot_->writeFieldBegin("add_edge_req", apache::thrift::protocol::T_STRUCT, 3);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::AddEdgesRequest>::write(*prot_, this->add_edge_req);
    xfer += prot_->writeFieldEnd();
  }
  if (this->upd_edge_req_ref().has_value()) {
    xfer += prot_->writeFieldBegin("upd_edge_req", apache::thrift::protocol::T_STRUCT, 4);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure,  ::nebula::storage::cpp2::UpdateEdgeRequest>::write(*prot_, this->upd_edge_req);
    xfer += prot_->writeFieldEnd();
  }
  if (this->edge_ver_ref().has_value()) {
    xfer += prot_->writeFieldBegin("edge_ver", apache::thrift::protocol::T_MAP, 5);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::map<::apache::thrift::type_class::integral, ::apache::thrift::type_class::list<::apache::thrift::type_class::integral>>, std::unordered_map< ::nebula::cpp2::PartitionID, ::std::vector<int64_t>>>::write(*prot_, this->edge_ver);
    xfer += prot_->writeFieldEnd();
  }
  xfer += prot_->writeFieldStop();
  xfer += prot_->writeStructEnd();
...
extern template void InternalTxnRequest::readNoXfer<>(apache::thrift::BinaryProtocolReader*);
extern template uint32_t InternalTxnRequest::write<>(apache::thrift::BinaryProtocolWriter*) const;
extern template uint32_t InternalTxnRequest::serializedSize<>(apache::thrift::BinaryProtocolWriter const*) const;
extern template uint32_t InternalTxnRequest::serializedSizeZC<>(apache::thrift::BinaryProtocolWriter const*) const;
extern template void InternalTxnRequest::readNoXfer<>(apache::thrift::CompactProtocolReader*);
extern template uint32_t InternalTxnRequest::write<>(apache::thrift::CompactProtocolWriter*) const;
extern template uint32_t InternalTxnRequest::serializedSize<>(apache::thrift::CompactProtocolWriter const*) const;
extern template uint32_t InternalTxnRequest::serializedSizeZC<>(apache::thrift::CompactProtocolWriter const*) const;
